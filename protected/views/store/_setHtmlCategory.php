...
<div class="header">
    <div class="logo">
        <a href="http://www.vipplaza.co.id">
            <div class="vip">
                <img src="<?php echo $this->baseUrl(); ?>/themes/front/bbm/themes/bbm/images/logo-vip.png"
                     alt="Vip Plaza"/>
            </div>
        </a>
        <a href="http://bbm.vipplaza.co.id">
            <div class="bbm">
                <img src="<?php echo $this->baseUrl(); ?>/themes/front/bbm/themes/bbm/images/bb-money-logo.png"
                     alt="BBM Money"/>
            </div>
        </a>
    </div>
...
<div class="promo-content ">
    <a href="http://www.vipplaza.com/fcuk.html?utm_source=line_fcuk&utm_medium=microsite&utm_campaign=lineshopping&utm_term=fcuk">
        <img class="banner" src="<?php echo $this->baseTheme(); ?>images/big.png" alt="">
    </a>

    <?php /*
    <div width="50px" align="center" style="margin-bottom:20px">
        <a href="http://line.me/ti/p/%40qbb5309i">
            <img height="36" border="0" alt="Friends Added"
                 src="http://biz.line.naver.jp/line_business/img/btn/addfriends_en.png">
        </a>
    </div>
    */
    ?>
        ...
        if (!empty($data)) {
            foreach ($data as $val) {
                ...
                <div class="product-line clearfix">
                    ...
                    <a href="<?php echo $this->baseUrl() . '/product-html/' . $value->entity_id . '-' . Vipplaza::url_title($value->name); ?>.html<?php echo $url_promo; ?>"
                       target="_blank">
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt=""
             src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/976024649/?value=1.000000&amp;label=AKHkCO-k8hwQyeiz0QM&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt=""
             src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/976024649/?value=1.00&amp;currency_code=USD&amp;label=cJLFCI_x4RsQyeiz0QM&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
...
<noscript><img height="1" width="1" alt="" style="display:none"
               src="https://www.facebook.com/tr?id=264403483731848&amp;ev=NoScript"/>
</noscript>
